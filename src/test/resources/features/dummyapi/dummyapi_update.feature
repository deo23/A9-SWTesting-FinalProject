...
@TC-M03-13
Scenario: Update lastName field with length in range 2-50 with registered id parameter
    Given the app-id in the request header is "662e389ebb70a717cf25946b"
    When the user sends a PUT request with updated lastname to the URL "https://dummyapi.io/data/v1/user/662e3c761846fb04fdd51dc9"
    Then the status response should be 200 OK
    And the response body should contain updated lastname user data with ID "662e3c761846fb04fdd51dc9"